...
//     baseUrl:
//       'https://veterans-learners-syndrome-computed.trycloudflare.com/api/v1',
//   }),
...
//   tagTypes: ['GetResources', 'ResourceBookmark'],

//   baseQuery: fetchBaseQuery({
//     // baseUrl: 'http://10.10.20.19:5000/api/v1',
//     // baseUrl: 'https://timothy-backend.onrender.com/api/v1',
//     baseUrl:
//       'https://grey-metals-disciplinary-immigrants.trycloudflare.com/api/v1',
...
export const baseApi = createApi({
  ...
  tagTypes: [
    ...
    'GetMyMeetings',
    'GetMyMeetingsHistory',
    'AddBookslot',
    'CancelMeeting',
    'CreateMeetingBySupervisor',
    'UpdateMeetingBySupervisor',
  ],
